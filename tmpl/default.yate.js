...
(function() {
    ...
    var j29 = [ 0, 'ctx', 2, p15, 0, 'name' ];

    var j30 = [ 0, 'ctx', 2, p16, 0, 'name' ];
    ...
    var j37 = [ 0, 'tags', 2, p28, 0, 'access' ];

    function p29(m, c0, i0, l0) {
        return cmpSN("alias", selectNametest('type', c0, []));
    }

    var j38 = [ 0, 'tags', 2, p29, 0, 'name' ];

    var j39 = [ 0, 'ctx', 2, p16, 0, 'value' ];

    var j40 = [ 0, 'ctx', 2, p15, 0, 'value' ];
    ...
    var j46 = [ 0, 'tags', 2, p34, 0, 'name' ];

    var j47 = [ 0, 'tags', 2, p31, 0, 'name' ];

    var j48 = [ 0, 'ctx', 2, p31, 0, 'name' ];

    var j49 = [ 0, 'ctx', 2, p34, 0, 'name' ];

    function p35(m, c0, i0, l0) {
        return cmpSN("constructs", selectNametest('type', c0, []));
    }

    var j50 = [ 0, 'tags', 2, p35, 0, 'name' ];
    ...
    var j55 = [ 0, 'tags', 2, p37 ];

    var j56 = [ 0, 'description' ];
    ...
    var j57 = [ 0, 'tags', 2, p38 ];

    var j58 = [ 0, 'nullable' ];

    var j59 = [ 0, 'nonNullable' ];
    ...
    M.t2 = function t2(m, c0, i0, l0, a0) {
        ...
        var r1 = '';
        var a1 = { a: {} };
        r1 += m.a(m, m.s(j32, c0), 'mdox-tag-types', a1, (function() {
            var r1 = [];
            var a1 = { a: {} };
            r1.push("type");
            r1.push("constant");
        ...
        var r1 = '';
        var a1 = { a: {} };
        r1 += m.a(m, m.s(j33, c0), 'item-tag', a1)
        r1 += closeAttrs(a1);
        ...
        if ((!(yr.externals['mdox-string-empty'])(nodeset2scalar( v9 )))) {
            r0 += "\n\n";
            r0 += ">";
            r0 += " *Alias:* ";
            r0 += "`";
    ...
    M.t3 = function t3(m, c0, i0, l0, a0) {
        ...
        //  var is-deprecated : boolean
        var v11 = nodeset2boolean( m.s(j19, c0) );
        ...
        for (var i1 = 0, l1 = items0.length; i1 < l1; i1++) {
            ...
            r1 += m.a(m, m.s(j32, c1), 'mdox-tag-types-str', a1)
            r1 += " ";
        ...
        if ((!(yr.externals['mdox-string-empty'])(nodeset2scalar( v24 )))) {
            r0 += "\n\n";
            r0 += ">";
            r0 += " *Alias:* ";
            r0 += "`";
        ...
        if ((!(yr.externals['mdox-string-empty'])(nodeset2scalar( v25 )))) {
            r0 += "\n\n";
            r0 += ">";
            r0 += " *This:* ";
            r0 += "`";
        ...
        if ((!(yr.externals['mdox-string-empty'])(xml2scalar( v19 )))) {
            r0 += "\n\n";
            r0 += ">";
            r0 += " *Arguments:*";
            r0 += "\n\n";
    ...
    M.t4 = function t4(m, c0, i0, l0, a0) {
        ...
        //  var is-deprecated : boolean
        var v26 = nodeset2boolean( m.s(j19, c0) );
        ...
        if (nodeset2boolean( (m.s(j70, c0)) )) {
            ...
            r1 += nodeset2scalar( m.s(j67, c0) );
        } else if (nodeset2boolean( (m.s(j68, c0)) )) {
            r1 += nodeset2scalar( m.s(j68, c0) );
        ...
        r1 += m.a(m, m.s(j33, c0), 'item-tag', a1)
        r1 += closeAttrs(a1);
        if (nodeset2boolean( (m.s(j71, c0)) )) {
            r1 += "\n\n";
            r1 += m.a(m, m.s(j71, c0), 'item-tag', a1)
        }
        if (nodeset2boolean( (m.s(j11, c0)) )) {
            r1 += "\n\n";
            r1 += m.a(m, m.s(j11, c0), 'item-tag', a1)
        ...
        r0 += v28;
        r0 += "\n\n";
        r0 += scalar2xml( (yr.externals['mdox-string-trim'])(xml2scalar( v29 )) );
        if ((!(yr.externals['mdox-string-empty'])(xml2scalar( v31 )))) {
            r0 += "\n\n";
            r0 += ">";
            r0 += " *Property:*";
            r0 += "\n\n";
        ...
        if ((!(yr.externals['mdox-string-empty'])(v30))) {
            r0 += "\n\n";
            r0 += "##### **Example**";
            r0 += "\n\n";
            r0 += scalar2xml( v30 );
    ...
    M.t5 = function t5(m, c0, i0, l0, a0) {
        ...
        //  var is-deprecated : boolean
        var v32 = nodeset2boolean( m.s(j19, c0) );
