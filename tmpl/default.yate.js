...
(function() {
    ...
    M.t3 = function t3(m, c0, i0, l0, a0) {
        ...
        r1 += m.a(m, m.s(j34, c0), 'item-tag', a1)
        r1 += closeAttrs(a1);
        if (nodeset2boolean( (m.s(j55, c0)) )) {
            r1 += "\n\n";
            r1 += m.a(m, m.s(j55, c0), 'item-tag', a1)
        }
        if (nodeset2boolean( (m.s(j11, c0)) )) {
            r1 += "\n\n";
            r1 += m.a(m, m.s(j11, c0), 'item-tag', a1)
