...
(function() {
    ...
    var j22 = [ 0, 'ctx', 2, p15, 0, 'receiver' ];

    function p16(m, c0, i0, l0) {
        return cmpSN("memberof", selectNametest('type', c0, []));
    }

    var j23 = [ 0, 'tags', 2, p16, 0, 'parent' ];
    ...
    var j26 = [ 0, 'tags', 2, p19, 0, 'name' ];

    function p20(m, c0, i0, l0) {
        return cmpSN("function", selectNametest('type', c0, []));
    }

    var j27 = [ 0, 'tags', 2, p20, 0, 'name' ];

    var j28 = [ 0, 'tags', 2, p15, 0, 'name' ];
    ...
    var j30 = [ 0, 'ctx', 2, p15, 0, 'name' ];

    var j31 = [ 0, 'ctx', 2, p20, 0, 'name' ];

    function p22(m, c0, i0, l0) {
        return cmpSN("constructs", selectNametest('type', c0, []));
    }

    var j32 = [ 0, 'tags', 2, p22, 0, 'name' ];
    ...
    var j39 = [ 0, 'tags', 2, p25 ];

    var j40 = [ 0, 'description' ];
    ...
    M.t2 = function t2(m, c0, i0, l0, a0) {
        ...
        if ((!(yr.externals['mdox-string-empty'])(nodeset2scalar( v16 )))) {
            r0 += "\n\n";
            r0 += ">";
            r0 += " *This:* ";
            r0 += "`";
    ...
    M.t3 = function t3(m, c0, i0, l0, a0) {
        ...
        //  var is-deprecated : boolean
        var v17 = nodeset2boolean( m.s(j19, c0) );
        ...
        if (nodeset2boolean( (m.s(j59, c0)) )) {
            r1 += nodeset2scalar( m.s(j59, c0) );
        } else if (nodeset2boolean( (m.s(j56, c0)) )) {
            r1 += nodeset2scalar( m.s(j56, c0) );
        } else if (nodeset2boolean( (m.s(j57, c0)) )) {
            r1 += nodeset2scalar( m.s(j57, c0) );
        } else if (nodeset2boolean( (m.s(j58, c0)) )) {
            r1 += nodeset2scalar( m.s(j58, c0) );
        } else if (nodeset2boolean( (m.s(j29, c0)) )) {
            r1 += nodeset2scalar( m.s(j29, c0) );
        } else if (nodeset2boolean( (m.s(j31, c0)) )) {
            r1 += nodeset2scalar( m.s(j31, c0) );
        ...
        r1 += m.a(m, m.s(j34, c0), 'item-tag', a1)
        r1 += closeAttrs(a1);
        if (nodeset2boolean( (m.s(j60, c0)) )) {
            r1 += "\n\n";
            r1 += m.a(m, m.s(j60, c0), 'item-tag', a1)
        }
        if (nodeset2boolean( (m.s(j11, c0)) )) {
            r1 += "\n\n";
            r1 += m.a(m, m.s(j11, c0), 'item-tag', a1)
        ...
        r0 += v19;
        r0 += "\n\n";
        r0 += scalar2xml( (yr.externals['mdox-string-trim'])(xml2scalar( v20 )) );
        if ((!(yr.externals['mdox-string-empty'])(v21))) {
            r0 += "\n\n";
            r0 += "##### **Example**";
            r0 += "\n\n";
            r0 += scalar2xml( v21 );
    ...
    M.t4 = function t4(m, c0, i0, l0, a0) {
        ...
        //  var is-deprecated : boolean
        var v22 = nodeset2boolean( m.s(j19, c0) );
        ...
        r0 += v23;
        r0 += "\n\n";
        r0 += scalar2xml( (yr.externals['mdox-string-trim'])(xml2scalar( v25 )) );
