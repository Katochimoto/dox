...
(function() {
    ...
    var j59 = [ 0, 'tags', 2, p38 ];

    var j60 = [ 0, 'description' ];
    ...
    var j61 = [ 0, 'tags', 2, p39 ];

    var j62 = [ 0, 'nullable' ];

    var j63 = [ 0, 'nonNullable' ];
    ...
    M.t2 = function t2(m, c0, i0, l0, a0) {
        ...
        var v2 = nodeset2boolean( m.s(j19, c0) );

        //  var is-readonly : boolean
        var v3 = nodeset2boolean( m.s(j20, c0) );
        ...
        var r1 = '';
        var a1 = { a: {} };
        r1 += " **" + nodeset2scalar( ( v7 ) ) + "**";
        var v8 = r1;

        //  var types : xml
        var r1 = '';
        var a1 = { a: {} };
        r1 += m.a(m, m.s(j33, c0), 'mdox-tag-types', a1, (function() {
            var r1 = [];
            var a1 = { a: {} };
            r1.push("type");
            r1.push("constant");
        ...
        var r1 = '';
        var a1 = { a: {} };
        r1 += m.a(m, m.s(j34, c0), 'item-tag', a1)
        r1 += closeAttrs(a1);
        ...
        if ((!(yr.externals['mdox-string-empty'])(v11))) {
            r0 += "`Access: " + scalar2xml( ( v11 ) ) + "` ";
        }
        if ((!(yr.externals['mdox-string-empty'])(nodeset2scalar( v12 )))) {
            r0 += "`Alias: " + nodeset2xml( ( v12 ) ) + "` ";
        }
        r0 += "\n\n";
    ...
    M.t3 = function t3(m, c0, i0, l0, a0) {
        ...
        //  var is-deprecated : boolean
        var v14 = nodeset2boolean( m.s(j19, c0) );
        ...
        var r1 = '';
        var a1 = { a: {} };
        if ((!(yr.externals['mdox-string-empty'])(v15))) {
            r1 += " *";
            r1 += v15;
            if (nodeset2boolean( (m.s(j25, c0)) )) {
                r1 += ":";
        ...
        for (var i1 = 0, l1 = items0.length; i1 < l1; i1++) {
            ...
            r1 += m.a(m, m.s(j33, c1), 'mdox-tag-types-str', a1)
            r1 += " ";
        ...
        if ((!(yr.externals['mdox-string-empty'])(v28))) {
            r0 += "`Access: " + scalar2xml( ( v28 ) ) + "` ";
        }
        if ((!(yr.externals['mdox-string-empty'])(nodeset2scalar( v29 )))) {
            r0 += "`Alias: " + nodeset2xml( ( v29 ) ) + "` ";
        }
        if ((!(yr.externals['mdox-string-empty'])(nodeset2scalar( v30 )))) {
            r0 += "`This: " + nodeset2xml( ( v30 ) ) + "` ";
        }
        r0 += "\n\n";
        r0 += scalar2xml( (yr.externals['mdox-string-trim'])(xml2scalar( v21 )) );
        if ((!(yr.externals['mdox-string-empty'])(xml2scalar( v24 )))) {
            r0 += "\n\n";
            r0 += "*Arguments:*";
            r0 += "\n";
            r0 += v24;
        ...
        if ((!(yr.externals['mdox-string-empty'])(v26))) {
            r0 += "\n\n";
            r0 += "*Fires:*";
            r0 += "\n";
            r0 += scalar2xml( v26 );
        }
        if ((!(yr.externals['mdox-string-empty'])(v27))) {
            r0 += "\n\n";
            r0 += "##### **Example**";
            r0 += "\n\n";
            r0 += scalar2xml( v27 );
    ...
    M.t4 = function t4(m, c0, i0, l0, a0) {
        ...
        //  var is-deprecated : boolean
        var v31 = nodeset2boolean( m.s(j19, c0) );
        ...
        var r1 = '';
        var a1 = { a: {} };
        if (nodeset2boolean( (m.s(j78, c0)) )) {
            r1 += nodeset2scalar( m.s(j78, c0) );
        } else if (nodeset2boolean( (m.s(j76, c0)) )) {
            r1 += nodeset2scalar( m.s(j76, c0) );
        } else if (nodeset2boolean( (m.s(j77, c0)) )) {
        ...
        r1 += m.a(m, m.s(j34, c0), 'item-tag', a1)
        r1 += closeAttrs(a1);
        if (nodeset2boolean( (m.s(j79, c0)) )) {
            r1 += "\n\n";
            r1 += m.a(m, m.s(j79, c0), 'item-tag', a1)
        }
        if (nodeset2boolean( (m.s(j11, c0)) )) {
            r1 += "\n\n";
            r1 += m.a(m, m.s(j11, c0), 'item-tag', a1)
        ...
        r0 += "\n\n";
        r0 += scalar2xml( (yr.externals['mdox-string-trim'])(xml2scalar( v35 )) );
        if ((!(yr.externals['mdox-string-empty'])(xml2scalar( v37 )))) {
            r0 += "\n\n";
            r0 += "*Propertys:*";
            r0 += "\n";
            r0 += v37;
        }
        if ((!(yr.externals['mdox-string-empty'])(v36))) {
            r0 += "\n\n";
            r0 += "##### **Example**";
            r0 += "\n\n";
            r0 += scalar2xml( v36 );
    ...
    M.t5 = function t5(m, c0, i0, l0, a0) {
        ...
        //  var is-deprecated : boolean
        var v38 = nodeset2boolean( m.s(j19, c0) );
        ...
        r0 += closeAttrs(a0);
        r0 += "## ";
        if ((!(yr.externals['mdox-string-empty'])(v40))) {
            r0 += scalar2xml( v40 );
            r0 += ": ";
        }
        r0 += nodeset2xml( v41 );
        ...
        r0 += "\n\n";
        r0 += scalar2xml( (yr.externals['mdox-string-trim'])(xml2scalar( v42 )) );
        if ((!(yr.externals['mdox-string-empty'])(v43))) {
            r0 += "\n\n";
            r0 += "##### **Example**";
            r0 += "\n\n";
            r0 += scalar2xml( v43 );
