...
(function() {
    ...
    var j37 = [ 0, 'tags', 2, p25 ];

    var j38 = [ 0, 'description' ];
    ...
    M.t3 = function t3(m, c0, i0, l0, a0) {
        ...
        if (nodeset2boolean( (m.s(j54, c0)) )) {
            r1 += "\n\n";
            r1 += m.a(m, m.s(j54, c0), 'item-tag', a1)
        }
        if (nodeset2boolean( (m.s(j11, c0)) )) {
            r1 += "\n\n";
            r1 += m.a(m, m.s(j11, c0), 'item-tag', a1)
