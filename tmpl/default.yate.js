...
(function() {
    ...
    var j12 = [ 0, 'tags', 2, p7, 0, 'description' ];
    ...
    var j16 = [ 0, 'tags', 2, p10, 0, 'description' ];

    var j17 = [ 0, 'ctx', 0, 'type' ];

    function p11(m, c0, i0, l0) {
        return cmpSN("constant", m.s(j2, c0)) || cmpSN("const", m.s(j2, c0)) || cmpSN("var", m.s(j2, c0)) || cmpSN("member", m.s(j2, c0)) || cmpSN("property", m.s(j17, c0)) || cmpSN("declaration", m.s(j17, c0)) || cmpSN("constant", m.s(j3, c0)) || cmpSN("member", m.s(j3, c0));
    }

    var j18 = [ 0, 'comments', 2, p11 ];

    function p12(m, c0, i0, l0) {
        return cmpSN("memberOf", selectNametest('type', c0, []));
    }

    var j19 = [ 0, 'tags', 2, p12, 0, 'parent' ];

    function p13(m, c0, i0, l0) {
        return cmpSN("property", selectNametest('type', c0, []));
    }

    var j20 = [ 0, 'ctx', 2, p13, 0, 'cons' ];

    function p14(m, c0, i0, l0) {
        return cmpSN("declaration", selectNametest('type', c0, []));
    }

    var j21 = [ 0, 'ctx', 2, p14, 0, 'receiver' ];

    function p15(m, c0, i0, l0) {
        return cmpSN("memberof", selectNametest('type', c0, []));
    }

    var j22 = [ 0, 'tags', 2, p15, 0, 'parent' ];
    ...
    var j31 = [ 0, 'tags', 2, p21 ];

    var j32 = [ 0, 'tags', 2, p17, 0, 'name' ];
    ...
    var j42 = [ 0, 'comments', 2, p26 ];

    function p27(m, c0, i0, l0) {
        return cmpSN("method", selectNametest('type', c0, []));
    }

    var j43 = [ 0, 'ctx', 2, p27, 0, 'cons' ];

    var j44 = [ 0, 'ctx', 2, p27, 0, 'receiver' ];
    ...
    var j47 = [ 0, 'tags', 2, p30, 0, 'name' ];

    var j48 = [ 0, 'tags', 2, p27, 0, 'name' ];

    var j49 = [ 0, 'ctx', 2, p27, 0, 'name' ];

    var j50 = [ 0, 'ctx', 2, p30, 0, 'name' ];

    function p31(m, c0, i0, l0) {
        return cmpSN("constructs", selectNametest('type', c0, []));
    }

    var j51 = [ 0, 'tags', 2, p31 ];

    var j52 = [ 0, 'tags', 2, p28, 0, 'name' ];

    var j53 = [ 0, 'tags', 2, p29, 0, 'name' ];

    var j54 = [ 0, 'tags', 2, p31, 0, 'name' ];
    ...
    var j69 = [ 0, 'tags', 2, p42 ];

    var j70 = [ 0, 'tags', 2, p36, 0, 'name' ];
    ...
    M.t1 = function t1(m, c0, i0, l0, a0) {
        ...
        r0 += scalar2xml( v0 );
        r0 += "\n\n";
        r0 += m.a(m, m.s(j13, c0), 'access', a0)
        r0 += m.a(m, m.s(j13, c0), 'tags-flags', a0, (function() {
            var r0 = [];
            var a0 = { a: {} };
            r0.push("deprecated");
        ...
        if (nodeset2boolean( (m.s(j16, c0)) )) {
            r0 += "© ";
            r0 += nodeset2xml( m.s(j16, c0) );
            r0 += "\n\n";
        }
        r0 += m.a(m, m.s(j13, c0), 'description', a0)
        r0 += m.a(m, m.s(j13, c0), 'example', a0)
        r0 += "\n\n";
    ...
    M.t2 = function t2(m, c0, i0, l0, a0) {
        ...
        var r1 = '';
        var a1 = { a: {} };
        r1 += m.a(m, m.s(j13, c0), 'mdox-tag-types', a1, (function() {
            var r1 = [];
            var a1 = { a: {} };
            r1.push("type");
            r1.push("constant");
        ...
        if ((!(yr.externals['mdox-string-empty'])(nodeset2scalar( m.s(j41, c0) )))) {
            r0 += "`Alias: " + nodeset2xml( ( m.s(j41, c0) ) ) + "` ";
        }
        r0 += "\n\n";
        r0 += m.a(m, m.s(j13, c0), 'description', a0)
        r0 += m.a(m, m.s(j13, c0), 'example', a0)
    ...
    M.t3 = function t3(m, c0, i0, l0, a0) {
        ...
        for (var i1 = 0, l1 = items0.length; i1 < l1; i1++) {
            ...
            r1 += m.a(m, m.s(j13, c1), 'mdox-tag-types-str', a1)
            r1 += " ";
        ...
        var r1 = '';
        var a1 = { a: {} };
        r1 += m.a(m, m.s(j13, c0), 'type-description', a1, (function() {
            var r1 = [];
            var a1 = { a: {} };
            r1.push("throws");
            r1.push("exception");
        ...
        var r1 = '';
        var a1 = { a: {} };
        r1 += m.a(m, m.s(j13, c0), 'argument-description', a1, (function() {
            var r1 = [];
            var a1 = { a: {} };
            r1.push("param");
            r1.push("arg");
        ...
        if ((!(yr.externals['mdox-string-empty'])(nodeset2scalar( m.s(j61, c0) )))) {
            r0 += "`This: " + nodeset2xml( ( m.s(j61, c0) ) ) + "` ";
        }
        r0 += "\n\n";
        r0 += m.a(m, m.s(j13, c0), 'description', a0)
